package com.leeraar.config;

import com.leeraar.services.security.JwtAuthenticationEntryPoint;
import com.leeraar.services.security.JwtUserDetailsService;
import com.leeraar.filters.JwtAuthorizationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/feedback/danny/**/**").permitAll()
